# Source-backed accuracy evidence

These 100 additional cases have independently justified diagnostic expectations.
They are included in `corpus-v1.json`, which contains 169 fixtures: 102 source
equations with independent expectation evidence and 67 synthetic cases.
The 100-equation accuracy gate now runs in ordinary PR CI as well as release
validation. This evidence does not establish real-world precision/recall or
complete the other release gates.
...
- Expected results require independent evidence. Exact arithmetic,
  dimensional exponent arithmetic and the documented grammar justify the
  expectations below; they are not captured analyzer output.
...
are shown with line breaks collapsed for display; the test expression
...
Review the transcription and its assumptions as well as the expected codes.
...
Source lines 1839–1839; family `signed-grouping`.

- Original: `a + (b - c - x) = a + b - c - x`
- Test: `a+(b-c-x)=a+b-c-x`
- Expected codes: `[]`; exit status: `0`.
...
Source lines 3314–3314; family `factoring`.
...
Source lines 4342–4343; family `rational-cancellation`.
...
Source lines 1841–1841; family `signed-grouping`.
...
Source lines 3331–3331; family `factoring`.
...
Source lines 4402–4403; family `rational-cancellation`.
...
Source lines 1855–1855; family `signed-grouping`.
...
Source lines 2273–2273; family `monomial-powers`.
...
Source lines 2274–2274; family `monomial-powers`.
...
Source lines 2517–2517; family `rational-cancellation`.
...
Source lines 5783–5783; family `factoring`.
...
Source lines 3021–3021; family `numeric-ratios`.
...
Source lines 8879–8880; family `phase-rule-counting`.
...
Source lines 5438–5438; family `linear-equations`.

- Original: `27 + 10x = 13x + 23`
- Test: `27+10*x=13*x+23`
- Expected codes: `["ALG001"]`; exit status: `1`.
- Meaning: Check universal identity only. A sourced exercise with a counterexample is a conditional equation, not an erroneous exercise.
- Assumptions: Commutative scalar arithmetic. No denominator restrictions.
...
Source lines 5523–5523; family `linear-equations`.
...
Source lines 5528–5528; family `linear-equations`.
...
Source lines 5530–5530; family `linear-equations`.
...
Source lines 5532–5532; family `linear-equations`.
...
Source lines 5537–5537; family `quadratic-equations`.
...
Source lines 5538–5538; family `cubic-equations`.
...
Source lines 5542–5542; family `quadratic-equations`.
...
Source lines 5544–5544; family `linear-equations`.
...
Source lines 5624–5624; family `parameter-equations`.
...
Source lines 5629–5629; family `parameter-equations`.
...
Source lines 5631–5631; family `parameter-equations`.
...
Source lines 5633–5633; family `parameter-equations`.
...
Source lines 6362–6363; family `rational-equations`.
...
Source lines 6384–6384; family `quadratic-equations`.
...
Source lines 6392–6392; family `quadratic-equations`.
...
Source lines 6460–6460; family `quadratic-equations`.
...
Source lines 6461–6461; family `quadratic-equations`.
...
Source lines 6467–6467; family `quadratic-equations`.
...
Source lines 6348–6349; family `cubic-equations`.
...
Source lines 6569–6569; family `parameter-equations`.
...
Source lines 6728–6728; family `parameter-equations`.
...
Source lines 5751–5752; family `rational-cancellation`.
...
Source lines 1307–1308; family `rational-cancellation`.
...
Source lines 1140–1141; family `specific-volume`.
...
Source lines 2353–2354; family `specific-heat`.
...
Source lines 2874–2875; family `first-law`.
...
Source lines 4717–4718; family `specific-first-law`.
...
Source lines 6724–6724; family `phase-mass-balance`.
...
Source lines 8703–8704; family `thermodynamic-potential`.
...
Source lines 1203–1204; family `gas-temperature-scale`.
...
Source lines 2068–2069; family `ideal-gas`.
...
Source lines 4012–4014; family `isobaric-first-law`.
...
Source lines 6733–6734; family `phase-volume-balance`.
...
Source lines 10208–10209; family `entropy-differential`.
...
Source lines 1208–1209; family `gas-temperature-scale`.
...
Source lines 5494–5495; family `carnot-heat-work`.
...
Source lines 1215–1215; family `gas-temperature-scale`.
...
Source lines 4806–4807; family `reservoir-entropy`.
...
Source lines 1302–1303; family `isothermal-compressibility`.
...
Source lines 6265–6265; family `heat-capacity-ratio`.
...
Source lines 5633–5634; family `reservoir-entropy`.
...
Source lines 1481–1482; family `mixture-gas-constant`.
...
Source lines 1553–1554; family `van-der-waals`.
...
Source lines 1584–1586; family `clausius-equation`.
...
Source lines 3410–3412; family `specific-heat`.
...
Source lines 7134–7136; family `phase-free-energy`.
...
Source lines 7156–7157; family `clapeyron`.
...
Source lines 7160–7162; family `clapeyron`.
...
Source lines 9269–9270; family `clapeyron`.
...
Source lines 7224–7225; family `clapeyron`.
...
Source lines 9325–9326; family `phase-volume-balance`.
...
Source lines 9345–9346; family `multicomponent-clapeyron`.
...
Source lines 7373–7374; family `latent-entropy`.
...
Source lines 7478–7479; family `latent-heat-capacity`.
...
Source lines 7529–7530; family `path-heat-capacity`.
...
Source lines 3701–3702; family `carnot-volume-ratios`.
...
Source lines 7592–7593; family `latent-heat-capacity`.
...
Source lines 9865–9867; family `solution-temperature-shift`.
...
Source lines 10065–10067; family `osmotic-pressure`.
...
Source lines 3042–3043; family `kinematic-velocity`.
...
Source lines 1480–1480; family `right-triangle`.
...
Source lines 7367–7367; family `cone-volume`.
...
Source lines 7479–7479; family `box-surface`.
...
Source lines 8859–8860; family `circle-geometry`.
...
Source lines 2394–2395; family `product-differential`.
...
Source lines 2390–2391; family `product-differential`.
...
Source lines 1668–1668; family `constant-acceleration`.
...
Source lines 5637–5638; family `reservoir-entropy`.
...
Source lines 5457–5458; family `carnot-heat-work`.
...
Source lines 4787–4788; family `first-law`.
...
Source lines 9023–9024; family `integration-by-parts`.

- Original: `\int u\, dx = ux - \int x\, du + C.`
- Test: `\int u\, dx = ux - \int x\, du + C`
- Expected codes: `["PARSE020"]`; exit status: `0`.
...
Source lines 7328–7329; family `partial-differentials`.
...
Source lines 7354–7354; family `variable-exponent`.
...
Source lines 1407–1408; family `decimal-approximation`.
...
Source lines 11979–11979; family `chemical-equilibrium-log`.

- Original: `\log K = 0`
- Test: `\log K = 0`
- Expected codes: `["PARSE021"]`; exit status: `0`.
- Meaning: Logarithm is a documented unsupported function.
- Assumptions: No mathematical truth judgment; informational skip is expected.

### thompson-calculus-121f8a5849ee

Source lines 6215–6216; family `exponential`.
...
Source lines 6462–6464; family `cube-root`.
...
Source lines 2708–2708; family `decimal-approximation`.
...
Source lines 6919–6920; family `trigonometry`.
...
Source lines 3518–3518; family `symbolic-radical`.
...
Source lines 7828–7829; family `symbolic-antiderivative`.
...
Source lines 5076–5076; family `signed-radical`.
...
Source lines 1479–1479; family `angle-notation`.
...
Source lines 1947–1948; family `proportions`.
...
Source lines 10950–10951; family `mixture-sequence`.
