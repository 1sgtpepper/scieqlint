...
def test_accessibility_diagnostic_is_cataloged_for_the_current_release() -> None:
    assert CATALOG["PORT002"].release == "v1.1.0"
    assert "(warning, v1.1.0)" in (explain_code("PORT002") or "")
