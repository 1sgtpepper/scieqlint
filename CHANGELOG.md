...
- The pre-commit hook now triggers a complete project-context check for supported
  source suffixes regardless of case, without treating staged paths as CLI input.
