...
- Hidden/excluded equation-label checks consume explicit project visibility facts. SciEqLint
  does not read ignored files or infer table-of-contents visibility from filenames.
